    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[85vh] flex flex-col z-10">
        ...
        <div className="overflow-y-auto flex-1 px-6 py-4 text-sm text-gray-700 space-y-5">
          ...
          <section>
            <h3 className="font-bold text-gray-900 mb-1">5. Subscription Term</h3>
            <p>The Client shall make a one-time payment for the selected device or chosen package. Upon full payment, InstaPulse will proceed with system installation and activation of the subscribed services.</p>
          </section>
          ...
          <section>
            ...
            <p className="mb-1">InstaPulse provides ongoing system monitoring, technical assistance, software updates, and preventive maintenance to ensure the reliability and proper functioning of all installed devices. This includes system performance checks, troubleshooting, and monthly on-site inspection of installed equipment.</p>
            <p className="mb-1">A mandatory monthly maintenance fee of <strong>₱500.00 (Five Hundred Pesos)</strong> per system shall be charged. This fee covers system monitoring, technical support, software maintenance, and monthly on-site inspection of installed equipment.</p>
            <p>Failure to settle the required maintenance fee may result in temporary suspension of system monitoring services, restricted access, or interruption of service until all outstanding balances are fully paid.</p>
          </section>
